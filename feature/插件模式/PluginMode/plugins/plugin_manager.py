...
class PluginManager:
    ...
    def __init__(self, config_path: Optional[str] = None, config_data: Optional[Dict] = None, plugin_dirs: Optional[List[str]] = None):
        """
        初始化插件管理器
    ...
    def _is_plugin_class(self, cls) -> bool:
        """检查是否为有效插件类"""
        return issubclass(cls, PluginBase) and cls != PluginBase and hasattr(cls, 'execute') and hasattr(cls, 'init')
