...
def multiscale_features(intensity=True, edges=True, texture=True, sigma_min=1, sigma_max=3, num_workers=None, channel_axis=-1):
    """多尺度特征

    Args:
        intensity (bool, optional): 是否计算灰度值. Defaults to True.
        edges (bool, optional): 是否计算边缘. Defaults to True.
        texture (bool, optional): 是否计算纹理. Defaults to True.
        sigma_min (int, optional): 最小的高斯核大小. Defaults to 1.
        sigma_max (int, optional): 最大的高斯核大小. Defaults to 3.
        num_workers (int or None, optional): 并行线程数. Defaults to None.
        channel_axis (int, optional): 通道轴. Defaults to -1.
